...
class PendingScreenBody extends StatefulWidget {
  @override
  _PendingScreenBodyState createState() => _PendingScreenBodyState();
}
  ...
  Future<allOrdersModel> getOrders() async {
    ...
    try {
      FormData formData = FormData.fromMap(
          {"api_key": apiUrls.apiKey, "vendor_id": "1", "order_status": "1"});
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding: const EdgeInsets.fromLTRB(
                                    1.0, 1.0, 1.0, 4.0),
                                child: Text(
                                  "Placed On - ${dataFetched[index].createdAt.substring(0, 10)}",
                                  style: GoogleFonts.inter(
                                      fontSize: h * 0.014,
...
class OperationCard extends StatefulWidget {
  ...
  _PendingScreenBodyState context;
